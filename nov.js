function getLocation() {
    ...
    function showLocation(position) {
        ...
        var novlat = 54.969655;
        var novlon = 82.6692288;

        var currentpositionlat=position.coords.latitude;
        var currentpositionlon=position.coords.longitude;

        var distance=getDistanceFromLatLonInMiles(novlat, novlon, currentpositionlat, currentpositionlon);
        document.getElementById("geodisplay").innerHTML="LATITUDE: " + currentpositionlat + "<br>LONGITUDE: " + currentpositionlon;
            ...
            alert("YOU ARE " + distance + " MILES FROM NOVOSIBIRSK");
    }
    ...
    function locationNovos() {
        window.location.href = "russia_images/novos_map.jpg";
    }