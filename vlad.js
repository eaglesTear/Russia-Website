function getLocation() {
    ...
    function showLocation(position) {
        ...
        var vladlat = 43.1736206;
        var vladlon = 131.8957532;

        var currentpositionlat=position.coords.latitude;
        var currentpositionlon=position.coords.longitude;

        var distance=getDistanceFromLatLonInMiles(vladlat, vladlon, currentpositionlat, currentpositionlon);
        document.getElementById("geodisplay").innerHTML="LATITUDE: " + currentpositionlat + "<br>LONGITUDE: " + currentpositionlon;
            ...
            alert("YOU ARE " + distance + " MILES FROM VLADIVOSTOK");
    }
    ...
    function locationVlad() {
        window.location.href = "russia_images/vlad_map.jpg";
    }